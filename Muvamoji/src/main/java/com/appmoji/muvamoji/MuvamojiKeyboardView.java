 ...
 */
public class MuvamojiKeyboardView extends KeyboardView {
     ...
     * @param defStyle
     */
    public MuvamojiKeyboardView(Context context, AttributeSet attrs, int defStyle) {
...
//                    MuvamojiIME.currentInstance.commitEmoji(variant);

                    // Change keyboard page.
                    MuvamojiIME.currentInstance.changeKeyboard(variant);
