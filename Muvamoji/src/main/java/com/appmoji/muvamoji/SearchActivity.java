...
public class SearchActivity extends Activity {
    ...
    private void switchIME()
    {
        ...
        if(hasDefaultIME && MuvamojiIME.currentInstance != null)
            MuvamojiIME.currentInstance.switchInputMethod(defaultIME);
        else
    ...
    private class CustomDownloadListener extends DownloadListener
    {
        ...
        public void onPostAllJsonDownload(EmojiDownloader downloader) {
            ...
            prefEditor.putString(
                    ...
                    getString(R.string.ime_category_id_history)
            );
            prefEditor.commit();
            if(loadingDialog != null)
            {
        ...
        public void onPostOneEmojiDownload(String emojiName) {
            ...
            if(MuvamojiIME.currentInstance != null)
                MuvamojiIME.currentInstance.invalidate(emojiName);
        }
    }
}
